...
* 2. Ajouter et commiter des fichiers
 ...
 <img width="955" height="156" alt="2" src="https://github.com/user-attachments/assets/afdb1456-67ac-47c3-8f4b-a32de9a5723f" />
  ...
  3. Ajoutez ce fichier à l'index et commitez-le en utilisant le message "Ajout du fichier
README".
  <img width="768" height="205" alt="3" src="https://github.com/user-attachments/assets/771b79bf-8f4d-4af9-b3cb-13c4c89840c3" />

  4. Créez un fichier main.py et ajoutez-y un simple script Python : print("Hello, Git!")
   nano main.py
 
  5. Ajoutez et commitez ce fichier en utilisant le message "Ajout du script Python principal".
  git add main.py
  ...
  6. Affichez tous les commits effectués.
   ...
   git log
  * 3 . Créer et fusionner des branches
...
* 4 . Travailler avec un dépôt distant sur GitHub
